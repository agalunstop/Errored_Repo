...
#added -v option to pass operating voltage from jobscript
...
#Example usage: python python_compare_3rd_edge.py -m decoder_op_ip -v 1.1 -f /home/external/iitb/nanditha/simulations/decoder_ip_opFF_rise -n 10 -t 180 -l 1
